...
export const RIVERS: Ghat[] = [
  ...
  /* ---------------------------------------------------------------- 02 */
  {
    ...
    reading: {
      ...
      hi: "इस साइट पर संगम के लिए जो खंड पढ़ा जाता है वह संगम के नीचे गंगा की मुख्य धारा पर है, इसलिए यह अंक गंगा और यमुना दोनों को एक साथ लिए हुए है। यह मॉडल किया हुआ प्रवाह है, गेज का पाठ नहीं, और उसी खंड के 1997 से 2025 तक के, वर्ष के इसी सप्ताह के अपने अभिलेख के सापेक्ष क्रमित है। शीत ऋतु में जब अंक गिरता है तो वह रेती का लौटना है, और वही भूमि है जिस पर माघ मेला खड़ा होता है।",
    },
    tradition: [
      {
        key: "sangam-snan",
  ...
  /* ---------------------------------------------------------------- 03 */
  {
    ...
    reading: {
      ...
      hi: "इस साइट पर मथुरा के लिए जो खंड पढ़ा जाता है वह विश्राम घाट के नीचे यमुना की मुख्य धारा पर है। उनका मॉडल किया हुआ अंक किसी पर्वतीय नदी जैसा नहीं, द्वारों की एक शृंखला जैसा बर्ताव करता है, क्योंकि यहाँ से ऊपर वे वही हैं। उनकी तुलना 1997 से 2025 तक, वर्ष के इसी सप्ताह के उनके अपने अभिलेख से की जाती है।",
    },
    tradition: [
      {
        key: "snan",
  ...
  /* ---------------------------------------------------------------- 04 */
  {
    ...
    reading: {
      ...
      hi: "इस साइट पर नासिक के लिए जो खंड पढ़ा जाता है वह रामकुंड के नीचे गोदावरी की मुख्य धारा पर है। यहाँ वे छोटी नदी हैं और तेज़ भी: वर्षा का एक सप्ताह उन्हें उस सप्ताह के सामान्य से कहीं ऊपर ले जा सकता है, और अप्रैल का पाठ उनके अपने अभिलेख के निचले सिरे पर बैठता है। अंक मॉडल किया हुआ प्रवाह है, 1997 से 2025 तक इसी सप्ताह के सापेक्ष क्रमित, और इसीलिए कुछ सौ का अंक यहाँ उफान हो सकता है और गंगा पर कुछ भी नहीं।",
    },
    tradition: [
      {
        key: "asthi-visarjan",
  ...
  /* ---------------------------------------------------------------- 05 */
  {
    ...
    reading: {
      ...
      hi: "इस साइट पर उज्जैन के लिए जो खंड पढ़ा जाता है वह रामघाट के पास शिप्रा पर है। उनके अंक छोटे हैं, हज़ारों नहीं, दसियों घन मीटर प्रति सेकंड, और उनके आकार की वर्षा-पोषित नदी यही करती है। उनकी तुलना केवल उन्हीं से की जाती है, 1997 से 2025 तक, वर्ष के इसी सप्ताह में, क्योंकि यही तुलना कुछ कहती है।",
    },
    tradition: [
      {
        key: "snan",
...
export const riverDetailContent = {
  ...
  hi: {
    ...
    reading: {
      ...
      provenance: [
        "प्रवाह कोपरनिकस आपातकालीन प्रबंधन सेवा के वैश्विक बाढ़ मॉडल से लिया हुआ मॉडल-प्रवाह है, जो इस धारा को ढकने वाले ग्रिड-खंड पर पढ़ा जाता है और दिन में एक बार प्रकाशित होता है। यह गेज का पाठ नहीं, मॉडल है, और यह साइट हर अंक के साथ मॉडल लिखती है।",
    ...
    tradition: {
      ...
      lede: "इस जल के सामने खड़े होकर लोग जो करते हैं। इसमें से बहुत कुछ इस साइट के हर शब्द से सदियों पुराना है।",
      kindLabels: {
