...
export const RIVERS: Ghat[] = [
  /* ---------------------------------------------------------------- 01 */
  {
    ...
    sacred: {
      en: [
        "Haridwar is where the Ganga finishes her descent through the hills and enters the plain. The name is read two ways, Hari-dwar, the gate of Vishnu, and Har-dwar, the gate of Shiva, and both are kept, because the town is the doorway to two sets of shrines, Badrinath in one direction and Kedarnath in the other. By the time she arrives she has run a long way from Gaumukh.",
        "Har Ki Pauri means the steps of Hari. Set into the ghat is Brahmakund, held to be where a drop of the amrit fell as it was carried away after the churning of the ocean, and it is that tradition which gives Haridwar one of the four Kumbh Melas. A stone on the ghat is venerated as bearing Vishnu's footprint, and the ghat takes its name from it.",
        "The water running past the steps is not the whole river. A short way upstream, at Bhimgoda, a channel is drawn off the main stem and the ghat is built on that channel; the main stream runs east of it, and the same works feed the Upper Ganges Canal, cut in the eighteen fifties and still carrying water into the Doab. Worth knowing when you read a flow figure for Haridwar, because the figure belongs to the river rather than to the channel between the steps.",
        "In daily practice this is one of the busiest working ghats in the country. The aarti is performed at dusk, and tarpan, shraddha and asthi visarjan are conducted through the day. A little downstream at Kankhal the Daksha Mahadev temple keeps the account of Daksha's yajna, the older story of the place and the reason the town was a tirtha before it was a ghat.",
      ],
      hi: [
  ...
  /* ---------------------------------------------------------------- 02 */
  {
    ...
    sacred: {
      en: [
        ...
        "Prayag means the place of sacrifice, and the tradition is that Brahma performed a yajna here. The city is called Tirtharaj, king of tirthas. The Magh Mela is held on the sands each year through Magha and the Kumbh at its twelve-year turn, and some pilgrims keep kalpavas, a month of residence on the sangam sands.",
        ...
        "Shraddha and pind daan at Prayagraj are conducted through the Prayagwal purohits, families who hold the right to officiate by descent and who keep pilgrim registers going back generations. That is how it is done here: in person, with the family present. Snanify arranges none of it, and names it because it is true of the place.",
      ],
      hi: [
  ...
  /* ---------------------------------------------------------------- 03 */
  {
    ...
    sacred: {
      en: [
        "Vishram Ghat takes its name from vishram, rest: the tradition of Braj is that Krishna rested here after the killing of Kansa. It is the central ghat of Mathura, and the parikrama of the town's ghats begins and returns here. The aarti at dusk is smaller and more domestic than at Haridwar, and belongs to the town rather than to visitors.",
        "In the Braj tradition the Yamuna is not addressed chiefly as a purifier. She is Krishna's own river, the water he played in and the gopis carried, approached with the affection due to someone loved rather than the awe due to a judge. The rites kept at this ghat carry that register, and it changes what is said.",
    ...
    caution: {
      en: "The Yamuna at Mathura carries a heavy pollution load for much of the year, and through the dry months a large share of what passes the ghat is regulated release and drain water rather than mountain flow. Anyone going there to bathe should know that beforehand and ask locally on the day. Nothing on this page is advice that the water is safe to enter.",
  ...
  /* ---------------------------------------------------------------- 04 */
  {
    ...
    caution: {
      en: "Ram Kund is where Nashik's families come to give their dead to the water. Asthi visarjan goes on there through the day, every day of the year. It is a place with grief standing in it, and it is not a viewpoint. This page describes the kund rather than showing it, and that is deliberate.",
